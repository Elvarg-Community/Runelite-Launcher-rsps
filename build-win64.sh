...
cp native/build-x64/src/Release/Elvarg.exe build/win-x64/
cp target/Elvarg.jar build/win-x64/
...
sha256sum build/win-x64/Elvarg.exe

dumpbin //HEADERS build/win-x64/Elvarg.exe
